...
/usr/bin/calibre-server --port $CALIBRE_PORT --listen-on $CALIBRE_IP --log /srv/calibre/log/server.log --access-log /srv/calibre/log/access.log --url-prefix $CALIBRE_URL_PREFIX  $CALIBRE_OPTIONS $CALIBRE_LIBRARY_PATH
